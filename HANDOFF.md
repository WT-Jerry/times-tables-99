...
- 快取：`styles.css?v=2`、`game.css?v=5`、`shell.js?v=1`、`app.js?v=3`、`select.js?v=3`、`play.js?v=7`。改檔要再加版本。
...
- 十題全對：紅框那塊空白（「測驗結果」上方）隨機放 `assets/win-yellow.png` 或 `assets/win-white.png`，左右置中，不准壓到標題或分數。不是全對不要放。
